...
class UnclaimSubCommand extends SubCommand
{
    ...
    */
    ...
    {
        return $sender instanceof Player && $sender->hasPermission("factionsZ.command.unclaim");
    }
    /**
    * @param CommandSender $sender
    * @param string[] $args
    ...
    */
    public function execute(CommandSender $sender, array $args)
    {
        ...
        {
            $sender->sendMessage(TextFormat::RED . $this->translateString("error.doesnt_have_claim"));
            return true;
        }
        
        $this->getPlugin()->setClaim($faction_name, []);
        $sender->sendMessage(TextFormat::GREEN . $this->translateString("unclaim.success", [$faction_name]));
